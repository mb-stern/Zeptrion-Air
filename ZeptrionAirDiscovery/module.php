...
class ZeptrionAirDiscovery extends IPSModuleStrict
{
    ...
    public function GetConfigurationForm(): string
    {
        ...
        // Discovery liest bestehende Instanzen nur für die Anzeige/Zuordnung. Es schreibt
            ...
            if ($reachable && $instance === null) {
                ...
                $rows[$host]['create'] = [
                    ...
                    'configuration' => [
                        ...
                        // beginnen neu angelegte Dimmer/Rollos sicher mit 4000 ms,
                        // unabhängig davon, welche alten Defaults eine frühere
                        // Modulversion beim Erstellen der Instanz gespeichert hat.
                        'Channel1UpTimeMs' => 4000,
                        'Channel1DownTimeMs' => 4000,
                        'Channel2UpTimeMs' => 4000,
                        'Channel2DownTimeMs' => 4000,
                        'Channel3UpTimeMs' => 4000,
                        'Channel3DownTimeMs' => 4000,
                        'Channel4UpTimeMs' => 4000,
                        'Channel4DownTimeMs' => 4000,
                        'ShowOnline' => true,
                        'ShowRSSI' => true,
                        'ShowScenes' => false,
                        'ShowIPAddress' => false,
